      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          >
            ...
            <p className="text-white mb-8">Last updated: December 2024</p>
            ...
            <div className="prose prose-lg max-w-none prose-invert">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">Services</h2>
              <p className="text-white mb-4">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">Quotes and Contracts</h2>
              <p className="text-white mb-4">
              ...
              <h2 className="text-2xl font-bold text-white mt-8 mb-4">Warranties</h2>
              <p className="text-white mb-4">
