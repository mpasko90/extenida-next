...
const HouseExtensions = () => {
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-extenida-primary to-extenida-secondary text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              House Extensions in <span className="text-extenida-accent">South West London</span>
            </h1>
                    ...
                    <ul className="space-y-2">
                      {area.features.map((feature, i) => (
                        <li key={i} className="flex items-start">
                          <Award className="w-5 h-5 text-extenida-accent mr-2 mt-1 flex-shrink-0" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">
              Ready to Start Your <span className="text-extenida-accent">Extension Project?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" className="border-white text-white hover:bg-white hover:text-extenida-primary px-8 py-3">
