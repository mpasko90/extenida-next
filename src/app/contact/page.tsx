...
/**
 * Strona "Kontakt" (Next.js App Router)
 * Zachowuje dotychczasowy wygląd i strukturę.
 * Komponent klienta (formularz, useState)
 */
                  ...
                  <CardContent>
                    <ul className="space-y-3 text-gray-600">
                      <li className="flex items-start">
                        ...
                        Free, no-obligation quotes within 48 hours
                      </li>
                      <li className="flex items-start">
                        <span className="w-2 h-2 bg-extendia-accent rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      ...
                      <li className="flex items-start">
                        <span className="w-2 h-2 bg-extendia-accent rounded-full mt-2 mr-3 flex-shrink-0"></span>
                        Full planning permission and building regs support
                      </li>
                      <li className="flex items-start">
                        <span className="w-2 h-2 bg-extendia-accent rounded-full mt-2 mr-3 flex-shrink-0"></span>
