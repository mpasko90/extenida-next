...
const YourJourney = () => {
  const journeySteps = [
    {
      ...
      description: "Free consultation to understand your needs, budget, and vision",
      icon: Phone,
      timeline: "Week 1"
    },
    {
  ...
  return (
    <PageLayout 
      title="Your Journey" 
      description="Discover the step-by-step process of working with Extendia for your home extension or renovation project."
    >
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Contact us today for your free consultation and take the first step towards your dream home.
            </p>
