...
export const ContactForm = ({
  ...
  <p className="text-slate-200 mb-4 text-sm sm:text-base">Ready to transform your home? Contact us for a free consultation and detailed quote.</p>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-5">
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-200"><a href={business.phone.href}>{business.phone.display}</a></p>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-200"><a href={business.email.href}>{business.email.address}</a></p>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-200 whitespace-pre-line">{business.registeredOffice}</p>
  ...
  const FormPanel = (
    <div className="bg-white/95 dark:bg-slate-900/70 backdrop-blur rounded-xl shadow-xl border border-slate-200/60 dark:border-slate-700 p-5 sm:p-6 md:p-8">
      {showHeadingsInForm && title && <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{title}</h2>}
      {showHeadingsInForm && subtitle && <p className="text-slate-600 dark:text-slate-300 mb-6">{subtitle}</p>}
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
      {showContactInfo && <div className="lg:col-span-1 self-start">{InfoBlock}</div>}
