...
const LoftConversionsTwickenham = () => {
  return (
    <PageLayout 
      title="Loft Conversions in Twickenham" 
      description="Professional loft conversion services in Twickenham - rugby town loft specialists."
    >
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Loft Conversions in <span className="text-extendia-accent">Twickenham</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Strong, well-built loft conversions in the home of rugby
            </p>
...
export default LoftConversionsTwickenham;
