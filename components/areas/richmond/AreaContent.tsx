...
const RichmondAreaContent = () => {
  ...
  const projects = [
    { title: 'Riverside Family Extension', location: 'Richmond Riverside', type: 'Double storey extension', value: '£82,000' },
    { title: 'Attic Suite Conversion', location: 'East Twickenham (Richmond border)', type: 'Hip-to-gable conversion', value: '£50,000' },
    { title: 'Garden-Facing Kitchen', location: 'St Margarets', type: 'Kitchen extension', value: '£32,000' }
  ];
    ...
    <PageLayout>
      ...
      <section className="py-20 bg-gradient-to-br from-extendia-primary to-extendia-secondary text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <Leaf className="w-16 h-16 text-extendia-accent mx-auto mb-6" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert design & build across Richmond, St Margarets and surrounding neighbourhoods.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: 'Richmond Hill', icon: MapPin, description: 'Prestige hillside residences' },
              { name: 'St Margarets', icon: TreePine, description: 'Family period streets' },
              { name: 'Kew', icon: MapPin, description: 'Historic botanical quarter' }
            ].map((area, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Premium-quality extensions and refurbishments for Richmond properties.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-gray-600">Professional {service.toLowerCase()} services in Richmond</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Selected builds showcasing our Richmond expertise.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-extendia-primary to-extendia-secondary text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Begin your extension or renovation journey with our Richmond specialists.
            </p>
...
export default RichmondAreaContent;
