  ...
  const faqs = [
    {
      ...
      answer: "The cost of a house extension in South West London typically ranges from £1,800 to £3,000 per square metre, depending on the size, specification, and location. Contact us for a detailed quote tailored to your project in Kingston, Putney, Richmond, Surbiton, Twickenham, or Wimbledon."
    },
    {
    ...
    {
      id: "planning-permission-process",
      question: "What is the planning permission process and how long does it take?",
      answer: "The planning permission process typically takes 8-12 weeks from submission to decision. We handle the entire process for you, including drawings, applications, and liaison with the council. Our experienced team ensures your application has the best chance of approval first time."
    },
    {
      id: "guarantee",
    ...
    },
    {
      ...
      answer: "Simply contact us via our online form or call us. We offer no-obligation quotes for all building projects in South West London."
    },
    {
      id: "timeline",
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: prefersReducedMotion ? 0.1 : 0.6, delay: prefersReducedMotion ? 0 : index * 0.1 }}
              >
                <AccordionItem 
                  value={faq.id} 
