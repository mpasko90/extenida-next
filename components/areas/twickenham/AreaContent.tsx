    ...
    <PageLayout>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Character-led extensions & conversions across Twickenham & St Margarets
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Why Extend in Twickenham?
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Twickenham offers riverside settings, period conservation areas and strong family demand—ideal conditions for high-quality, value-adding home extensions.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                {[ 'Conservation character', 'Riverside & green spaces', 'Strong family market', 'Excellent school access' ].map((feature, index) => (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Design & build expertise across Twickenham, St Margarets and surrounding neighbourhoods.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: 'St Margarets', icon: MapPin, description: 'Period family streets' },
              { name: 'Twickenham Green', icon: TreePine, description: 'Heritage terraces' },
              { name: 'East Twickenham', icon: MapPin, description: 'River-adjacent homes' }
            ].map((area, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Our Twickenham Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Tailored extensions, loft conversions and refurbishments for Twickenham homes.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-gray-600">Professional {service.toLowerCase()} services in Twickenham</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Recent Twickenham Projects
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Selected design & build work across Twickenham and St Margarets.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Transform Your Twickenham Home?
            </h2>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Begin with a consultation from our Twickenham-focused team.
            </p>
...
export default TwickenhamAreaContent;
