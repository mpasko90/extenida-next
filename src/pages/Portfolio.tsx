...
const Portfolio = () => {
  ...
  return (
    <PageLayout 
      title="Portfolio" 
      description="View our portfolio of completed home extensions, loft conversions, and renovations across South West London."
    >
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Discover our completed projects across South West London, showcasing quality craftsmanship and innovative design.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <Card className="overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-extendia-accent font-bold">{project.budget}</span>
                    </div>
