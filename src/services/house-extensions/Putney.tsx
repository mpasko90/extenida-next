...
const HouseExtensionsPutney = () => {
  return (
    <PageLayout 
      title="House Extensions in Putney" 
      description="Professional house extension services in Putney - expert builders with riverside property experience."
    >
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              House Extensions in <span className="text-extendia-accent">Putney</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Riverside house extensions in Putney with specialist flood-resistant construction
            </p>
...
export default HouseExtensionsPutney;
