...
const LoftConversionsSurbiton = () => {
  return (
    <PageLayout 
      title="Loft Conversions in Surbiton" 
      description="Professional loft conversion services in Surbiton - family-focused loft conversions."
    >
      {/* Hero Section */}
...
export default LoftConversionsSurbiton;
